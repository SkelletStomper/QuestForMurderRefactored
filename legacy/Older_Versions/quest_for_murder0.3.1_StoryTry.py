...
while not gamefinished:
    ...
    print("My name is deuhtsh, and this is my quest for you. End the evening of bloodlust by killing monsters.")
    ...
    while stage < 6 and not gamefinished:
        if stage == 0:
            ...
            while stage == 0:
                ...
                print("(3)Who are you?")
                print("(4)I just wand to drink something.")
                ...
                if dialog == 1:
                    ...
                    if dialog == 1 and paid:
                        ...
                        print("As you drink the bottle of beer, it tastes like really old water. You decide that you do not want to know whats inside.")
                        drinksdrunken += 1
