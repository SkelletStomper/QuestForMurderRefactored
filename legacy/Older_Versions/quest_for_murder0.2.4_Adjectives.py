...
#Role selector
while rolechosen2 == False:
    rolechosen = False
    while rolechosen == False:
        role = input("What will you be?")
        if role == ("knight"):
            roledescriptions = ("The Knight is a Tank. He has high armor, and high Hp. But he has low Heal and a decreased crit modifier, and isnt that good at dodging. He starts with 1 Healing Potion.")
            maxhp = 24
            dmg = 5
            armor = 3
            crtmdf = -1
            ...
            roledescriptions = ("An agile assasin. He Has a high crit modifier, and is really good at dodging. His damage is absolutely superior, but he has no armor and low health. He starts with 2 Grenades.")
            maxhp = 10
            dmg = 7
            armor = 0
            crtmdf = 2
            ...
            roledescriptions = ("A filthy cleric, Patches doesnt like him. He has extremely high Heal, and a bit armored. Only his damage is a bit low.")
            maxhp = 14
            dmg = 4
            armor = 1
            crtmdf = 0
            ...
            roledescriptions = ("He kills everything, as long he doesnt get hit.")
            maxhp = 1
            dmg = 10
            armor = 0
            crtmdf = 5
            ...
            roledescriptions = ("Definitly balanced.")
            maxhp = 50
            dmg = 9
            armor = 5
            crtmdf = 5
            ...
            roledescriptions = ("Extremely weak in every aspect, But has a lot of potions.")
            maxhp = 8
            dmg = 2
            armor = 0
            crtmdf = 0
            ...
            roledescriptions = ("This is for testing purposes")
            maxhp = 200
            dmg = 10
            armor = 0
            crtmdf = 0
