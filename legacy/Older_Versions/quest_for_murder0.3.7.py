    ...
    while stage < 6 and not gamefinished:
        ...
        if stagename == "village":
            ...
            if encounterrandom == 1:
                ...
                print("You find a old hut. Inside you find a couldron, lots of unreadable books and destroyed potions, plus a something that is kind of looking like a futuristic gun. Only a Health potion seems to be intact. You take it with you. You leave the hut, but in front of it there is now a monster, which promptly attacks you!")
