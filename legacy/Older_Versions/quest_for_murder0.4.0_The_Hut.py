...
while not gamefinished:
    ...
    name = input("The Bar keeper, the only other person in this room, nods to you. He says: \"Well, finally awake, are you? Let me introduce myself. I am Deuhtsh, the owner of this nasty little bar. So whats your name?\"")
    ...
    print("So this is my EPIC quest for you. End the evening of bloodlust by killing monsters. For this, I give you the quest log. With this tool you will be able to quickly renind you of your actions.")
    ...
    while stage < 6 and not gamefinished:
        ...
        if stagename == "swamp hut":
            ...
            while stagename == "swamp hut":
                ...
                print("(5) Im leaving now.")
                dialog = input("")
                if dialog == "1":
                    if hagcalm:
                        print("\"You know you already said that, do you? Well, as i said, theres a healing potion in the hut\".")
                    else:
                        print("\"Oh, im sorry, I didnt knew that.\" She looks to the corpse of " + title + mnstrtp + ". \"Thanks for that, that would have been a bad surprise if you were not there.")
                        print("There is a healing potion in the hut, take it if you want.\"")
                        hagcalm = True
                elif dialog == "2":
                    if hagcalm:
                    ...
                    if hagcalm:
                        ...
                        if dialog == "here":
                            ...
                            print("\"I guess you woke up in deuhtshs bar, didnt you? Well, I cant tell you really much about this land before the evening of bloodlust, for I am not born here. I got drawn into this world, also waking up in the bar. This is now really long time ago. But I think the same happened to you, although i dont know why it happened.")
                    ...
                    if hagcalm:
                        print("\"Well, actually yes. If you should someday come to the plateau of champions, then wander till you come to an wheat field. In the center there should be an type of cabin, were should be some interesting stuff.\"")
                        hagboss = True
                    else:
        ...
        while mnstrchoosen == False:
            if stage == 1:
                ...
                if monty == 1 and not GLaDEaD and hagboss:
                    ...
                    title = "the "
                    titleBig = "A whole"
                    information = "Well, you are fucked. Good luck winning against a whole army of bloodthirsty soldiers..."
                    ...
                    title = "the "
                    titleBig = "The "
                    information = "Someday in the past, Goblins made peace with the Humans, after decades of war, and saw that they arent to different to Humans. But through the evening of bloodlust nearly all living beings became corrupted, the goblins were no exception. Their King is a humongous beast, with gigantic curved swords and iron plate armor."
        ...
        if stagename == "village":
            ...
            encounterrandom == random.randint(1,3)
            if mnstrtp == "siren":
                print("On your Journey, you suddenly hear overworldly singing. You just have to search for the source of this songs...  you finally come to an oil pond, a hole filled with black, bubbling goo, emitting explosive, toxinous gases. There are not a few corpses around, some looking human, others dont, all in different states of rot.")
