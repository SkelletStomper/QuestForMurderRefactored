...
while not gamefinished:
    ...
    #weapons
    weaponid = 0
    weaponname = ["bare fist","longsword","curved dagger","maze","spoon","spear","heavy warhammer"]
    weapondmg = [0,3,2,2,0,3,5]
    weaponamr = [0,0,0,0,0,0,1]
    weaponweight = [0,3,1,2,0,3,7]
    weaponclass = ["fist","sword","dagger","maze","joke","spear","maze"]
    weaponattribute = ["none","none","none","blessed","mirror","none","heavy"]
    ...
    offhandattribute = ["none","none","none"]
    ...
    armoramr = [0,3,1,0]
    armorweight = [0,4,1,0]
    armorattribute = ["none","heavy","none","stenching"]
    ...
    while not rolechosen2:
        ...
        while not rolechosen:
            ...
            if role == "knight":
                ...
                roledescription = "A filthy cleric, Patches does not like him. He has extremely high Heal, and a bit armored. He starts with a maze, which is blessed."
                maxhp = 14
                basedmg = 2
                weaponid = 3
                offhandid = 0
                ...
                if do == "atk":
                    ...
                    if hpe < 1:
                        ...
                        if randomnumb == 1:
                            ...
                            print("You attacked for " + str(int((dmg)*acc)) + " damage, and destroyed an importan organ." + title + mnstrtp + " falls backwards and does not get up again.")
                        else:
                            print("You attacked for " + str(int((dmg)*acc)) + " damage, which was a lethal hit!")
                    else:
                    ...
                    print("Weapon damage: " + weapondmg[weaponid])
                    print("Weapon protection: " + weaponamr[weaponid])
                    print("Weapon weight: " + weaponweight[weaponid])
                    print("Weapon attribute: " + weaponattribute[weaponid])
