...
while not gamefinished:
    ...
    #weapons
    weaponid = 0
    weaponname = ["bare fist","longsword","curved dagger","maze","spoon","spear"]
    weapondmg = [0,3,2,2,0,3]
    weaponamr = [0,0,0,0,0,0]
    weaponweight = [0,3,1,2,0,3]
    weaponclass = ["fist","sword","dagger","maze","joke","spear"]
    weaponattribute = ["none","none","none","blessed","mirror","none"]
    ...
    #armor
    armorid = 0
    armorname = ["normal clothing","plate armor","smooth leather armor"]
    armoramr = [0,3,1]
    armorweight = [0,4,1]
    armorattribute = ["none","heavy","none"]
