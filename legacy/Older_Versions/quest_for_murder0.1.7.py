                ...
                if dodge + random.randint(0,10) > 9:
                    ...
                    if psnchance > 0:
                        if (psnchance - psnrsst)-random.randint(1,10) > 0:
                            psndurcur += psndur
                            print("You got poisoned for " + str(poisoncurdur) + " rounds in total, dealing " + str(stage) + " damage per round until you heal yourself!")
                    if poisoncurdur > 0:
                        hp = hp - stage
                        poisoncurdur = poisoncurdur - (1 + psnrsst)
                        print("You got " + str(stage) + " poison damage, leaving you with " + str(hp) + " and " + str(poisoncurdur) + " rounds left poisoned!")
